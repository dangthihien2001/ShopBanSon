			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Đặng Thị Hiền-191201751 và Nguyễn Thị Quỳnh Như-191203771, trường đại học Giao Thông Vận Tải
					</p>
...
cảm ơn thầy cô và các bạn đã xem sản phẩm của chúng em <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<div class="btn-back-to-top" id="myBtn">
		...
		<!--Kích chọn xem một sản phẩm -->
	{{-- <!-- Modal1 -->
