			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						@else
						<a href="{{ URL::to('/dangnhap') }}" class="flex-c-m trans-04 p-lr-25">
							Đăng Ký / Đăng Nhập
						</a>						
						@endif
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li>
								<a href="{{ URL::to('/TrangChu') }}">Trang Chủ</a>
							</li>

							<li >
								<a href="{{ URL::to('/SanPham') }}">Sản Phẩm</a>
							</li>
							...
							<li>
								<a href="about.html">Liên Hệ</a>
							</li>

							<li>
								<a href="contact.html">Giới Thiệu</a>
							</li>
						</ul>
					</div>	
